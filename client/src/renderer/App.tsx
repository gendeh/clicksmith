    ...
    return (
      <div className="app-shell">
        <section className="card" style={{ maxWidth: 760 }}>
          ...
          <div className="inline-alert">{startupError}</div>
      ...
      <div className="overlay-root">
        ...
        >
          ...
          <div className="overlay-actions">
            ...
            <button className="btn btn-overlay" onClick={isPlaybackBusy ? stopPlayback : startPlayback}>
    ...
    <div className="app-shell">
      ...
      <header className="topbar">
        ...
        <div className="topbar-actions">
          ...
          <div className={`chip ${isPlaybackBusy ? 'chip-live' : ''}`}>
      ...
      {playbackErrorDisplay && (
        <div className="inline-alert">Playback error: {playbackErrorDisplay}</div>
      )}

      {recordingError && <div className="inline-alert">Recording error: {recordingError}</div>}
